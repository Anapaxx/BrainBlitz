                ...
                <div v-if="isUserSignedIn && !isSpecialPage" class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-auto fw-bold">
                        <li class="nav-item align-self-end mb-1 d-lg-none d-lg-block">
                            <a class="nav-link" :class="{ 'text-white': isActiveLink('/') }" href="/">Home</a>
                        </li>
                        <li class="nav-item align-self-end mb-1">
                            <a class="nav-link" :class="{ 'text-white': isActiveLink('/amici') }" href="/amici">Amici</a>
                        </li> 
                        <li class="nav-item align-self-end mb-1">
                            <a class="nav-link" :class="{ 'text-white': isActiveLink('/badge') }" href="/badge">Badge</a>
                        </li>
                        ...
                        <a href="/" class="text-decoration-none" :class="{ 'text-white': isActiveLink('/') }"> <span class="homelogo d-none d-lg-block material-symbols-outlined">home</span></a>
                    </ul>
                </div>
            </div>
        </nav>
