    ...
    export default defineComponent({
        ...
        data() {
            return {
                ...
                badgesbloccati: false as boolean
            }
        },
        methods: { 
            Utente(){
            ...
            sbloccaBadge() {
                if (this.utente) {
                    ...
                    if (this.max >= 2) {
                        ...
                        notifiche.push("Hai sbloccato un nuovo badge!");
                    }
                    if (this.punteggio >= 4) {
                    ...
                    if (notifiche.length > 0) {
                        this.badgesbloccati = true;
                        this.mostraNotifiche(notifiche);
                    } else {
                        this.badgesbloccati = false; // Nessun badge sbloccato
                    }
    }
},
            ...
            mostraNotifiche(notifiche: string[]) {
        ...
        <div class="row riga text-center col-12">
            ...
            <div class="row text-center col-12">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 mb-5">
                    ...
                    <div class="fs-3">N° risposte corrette: {{ punteggio }}/5</div>
                    <div class="fs-3">N° risposte consecutive: {{ max }}</div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 mb-5">
                    <div class="mb-3 fs-1 useravv">{{ avversario }}</div>
                    <div class="fs-3">N° risposte corrette: {{ punteggioavversario }}/5</div>
                </div>
